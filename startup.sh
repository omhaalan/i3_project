...
i3-msg 'exec "google-chrome-stable --args --new-window  https://todoist.com/app/project/2254208200"'
i3-msg 'exec "google-chrome-stable --args --new-window https://freedom.to/dashboard"'
sleep .5

#End the day; clean up todos
i3-msg 'workspace 0:End the day; exec "google-chrome-stable --args --new-window https://todoist.com/app/project/2269572090"'
i3-msg 'workspace 0:End the day; exec "google-chrome-stable --args --new-window https://todoist.com/app/project/2254208200"'
i3-msg 'workspace 0:End the day; exec "google-chrome-stable --args --new-window https://todoist.com/app/project/2233941560"'

sleep .5


#Planning the day
i3-msg 'workspace 10:Start the day; exec "google-chrome-stable --args --new-window https://todoist.com/app/project/2269572090"'
